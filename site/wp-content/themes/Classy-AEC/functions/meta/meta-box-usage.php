...
$classy_meta_boxes[] = array(
	...
	'fields' => array( // list of meta fields
		...
		array(
			'name' => 'Display Order',
			'desc' => 'This number is used to order the highlights on the home page. The lower the number the earlier it\'s shown on the home page.',
			'id' => $prefix . 'highlights_order',
			'type' => 'text',
			'std' => ''
		),
...
$classy_meta_boxes[] = array(
	...
	'fields' => array(
		...
		array(
			'name' => 'Display Order',
			'desc' => 'This number is used to order the services on the home page. The lower the number the earlier it\'s shown on the home page.',
			'id' => $prefix . 'services_order',
			'type' => 'text',
			'std' => ''
		),
	)
