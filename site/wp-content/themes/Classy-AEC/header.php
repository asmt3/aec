...
jQuery(function($){
	$(document).ready(function(){
		...
		$('#slider_nivo').nivoSlider({
			...
			animSpeed: <?php if($options['nivo_animation_speed']) { echo $options['nivo_animation_speed']; } else { echo '750'; } ?>,
			pauseTime: <?php if($options['nivo_pause_time']) { echo $options['nivo_pause_time']; } else { echo '8000'; } ?>,
...
<!--
        <div id="phone">
					<span>Telephone: </span>
					<tel><?php echo $options['phone']; ?></tel>
        </div>
-->
				<div id="accred">
					<ul>
						<li>
							<a href="http://niceic.com/" target="_blank">
								<img src="<?=get_bloginfo('stylesheet_directory') . '/images/AEC/accred/niceic.png' ?>" alt="NiC EIC" />
							</a>
						</li>
						<li>
							<a href="http://www.lshcontractorplus.co.uk/lsh/" target="_blank">
								<img src="<?=get_bloginfo('stylesheet_directory') . '/images/AEC/accred/contractorplus.png' ?>" alt="Contractor Plus" />
							</a>
						</li>
						<li>
							<a href="http://www.safecontractor.com/" target="_blank">
								<img src="<?=get_bloginfo('stylesheet_directory') . '/images/AEC/accred/safecontractor.png' ?>" alt="SafeContractor Approved" />
							</a>
						</li>
						<li>
							<a href="http://www.british-assessment.co.uk/services/iso-certification/iso-9001-certification/" target="_blank">
								<img src="<?=get_bloginfo('stylesheet_directory') . '/images/AEC/accred/iso9001.png' ?>" alt="ISO9001" />
							</a>
						</li>
						<li>
							<a href="http://www.british-assessment.co.uk/services/iso-certification/iso-14001-certification/" target="_blank">
								<img src="<?=get_bloginfo('stylesheet_directory') . '/images/AEC/accred/iso14001.png' ?>" alt="ISO14001" />
							</a>
						</li>
