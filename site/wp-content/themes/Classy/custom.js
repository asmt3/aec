jQuery(function($){
	...
	// animate read more links --------------------------->
		$('.read-more').hover(function(){  
 			$(this).animate({paddingRight: '10px'}, 500); }
			,function(){
  			$(this).animate({paddingRight: '7px'}, 500);
  		});
		
	// Equal Hights, Helps Fix Floats --------------------------->
	equalHeight($(".testimonial"))
	equalHeight($(".pricing-table"))
	equalHeight($(".home-blog-item"))
	...
	//Animate Recent Posts Widget --------------------------->
	$('.widget-recent-posts li').hover(function(){  
