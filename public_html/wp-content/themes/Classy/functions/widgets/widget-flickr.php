...
class classy_flickr extends WP_Widget {
	
	function classy_flickr() {
		
		// define widget title and description
		$widget_ops = array('classname' => 'classy_flickr_widget',
							'description' => __( 'Pulls in images from your Flickr account.', 'classy') );
		// register the widget
		$this->WP_Widget('classy_flickr', __('Flickr', 'classy'), $widget_ops);
	...
	<?php _e('Title', 'classy'); ?></label>
	<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>" /></p>
	
	<p><label for="<?php echo $this->get_field_id('id'); ?>">
	<?php _e('Flickr ID', 'classy'); ?>(<a href="http://www.idgettr.com" target="_blank">idGettr</a>):</label>
...
add_action('widgets_init', create_function('', 'return register_widget("classy_flickr");'));	
?>